...
calendar_events = [
    ...
    # --- 정확히 정정된 6월 2주차 신규 데이터 (총 6건) ---
    {
        "title": "📦 [MD] 삼계탕 공박스 취합\n👤 담당: 이도현\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-15", "color": "#F1948A"  # 파스텔 핑크
    },
    {
        "title": "🔍 [지원] 행사 역로스 이상파악\n👤 담당: 임명섭\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-15", "color": "#7FB3D5"  # 파스텔 블루
    },
    {
        "title": "🛵 [O4O] 배달/픽업 10차\n👤 담당: 홍민규\n📝 방법: 점포경영시스템\n🎯 주체: OFC개별", 
        "start": "2026-06-15", "color": "#FAD7A0"  # 파스텔 피치
    },
    {
        "title": "📊 [지원] 재고조사 지연점(18점)\n👤 담당: 유찬울\n📝 방법: 점포경영시스템\n🎯 주체: OFC개별", 
        "start": "2026-06-15", "color": "#A9DFBF"  # 파스텔 그린
    },
    {
        "title": "👤 [지원] 실운영자 정보 취합\n👤 담당: 김동욱\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-29", "color": "#C39BD3"  # 파스텔 퍼플
    },
    {
        "title": "🍗 [MD] 치킨25 5월 소급\n👤 담당: 최원필\n📝 방법: 점포경영시스템\n🎯 주체: OFC개별", 
        "start": "2026-06-30", "color": "#F7DC6F"  # 파스텔 옐로우
    }
]
