...
calendar_events = [
    ...
    # --- 신규 추가 데이터 (5/25 안내분 - 총 8건) ---
    {
        "title": "📺 [기타] 리테일미디어 설치\n👤 담당: 윤광복/오봉식\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-08", "color": "#C39BD3"
    },
    {
        "title": "📱 [마케팅] 지역화폐 MPM\n👤 담당: 양소연\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-08", "color": "#F1948A"
    },
    {
        "title": "🍗 [MD] 치킨25 추가도입\n👤 담당: 최원필\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-01", "color": "#7DCEA0"
    },
    {
        "title": "🍕 [MD] 고피자 추가도입\n👤 담당: 배승섭\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-01", "color": "#F8C471"
    },
    {
        "title": "🍕 [MD] 고피자 진열장 테스트\n👤 담당: 배승섭\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-01", "color": "#85C1E9"
    },
    {
        "title": "💳 [MD] 구글 G-Pin 집기\n👤 담당: 송정환\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-06-08", "color": "#F7DC6F"
    },
    {
        "title": "🛵 [O4O] 배달/픽업 9차\n👤 담당: 박정은\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-06-02", "color": "#FAD7A0"
    },
    {
        "title": "🏖️ [지원] 해안가 성수기 지원\n👤 담당: 임명섭\n📝 방법: 엑셀/PPT\n🎯 주체: 부문지원팀", 
        "start": "2026-06-08", "color": "#A3E4D7"
    }
]
