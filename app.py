...
calendar_events = [
    ...
    # --- 9월 2~3주차 신규 데이터 (총 5건) ---
    {
        "title": "💳 [MD] 로블록스 매대 취합\n👤 담당: 송정환\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-09-14", "color": "#F5B041"  # 파스텔 오렌지
    },
    {
        "title": "❄️ [지원] 냉난방기 화학세척\n👤 담당: 김치영\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-09-18", "color": "#85C1E9"  # 파스텔 블루
    },
    {
        "title": "🏆 [지원] 20주년 경영주 시상\n👤 담당: 조원중\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-09-21", "color": "#D7BDE2"  # 파스텔 퍼플
    },
    {
        "title": "🍫 [MD] 빼빼로데이 반품상품\n👤 담당: 김완호\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-09-21", "color": "#F1948A"  # 파스텔 핑크레드
    },
    {
        "title": "🍗 [MD] 8월 치킨25 소급\n👤 담당: 최원필\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-09-30", "color": "#A9DFBF"  # 파스텔 그린
    }
]
