...
calendar_events = [
    ...
    {"title": "🛒 [지원] 장보기 추가 (양희진 / 시스템 / OFC개별)", "start": "2026-04-20", "end": "2026-04-27", "color": "#8E44AD"},
    {"title": "🛵 [O4O] 배달/픽업 (박정은 / OFC포탈 / OFC개별)", "start": "2026-04-20", "end": "2026-04-27", "color": "#FFA421"},
    {"title": "🍗 [MD] 치킨25 소모품 (최원필 / OFC포탈 / OFC개별)", "start": "2026-04-13", "end": "2026-04-30", "color": "#00C092"},
]
