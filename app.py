...
calendar_events = [
    ...
    # --- 6월 3주차 통합 신규 데이터 (총 4건) ---
    {
        "title": "💳 [MD] 구글 G-Pin 집기\n👤 담당: 송정환\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-06-22", "color": "#76D7C4"  # 파스텔 아쿠아
    },
    {
        "title": "🛵 [O4O] 요기요 미운영점 정리\n👤 담당: 상현수\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-06-22", "color": "#F1948A"  # 파스텔 핑크 레드
    },
    {
        "title": "📞 [지원] 점포 전화번호 수정\n👤 담당: 허수연\n📝 방법: MS폼즈\n🎯 주체: OFC개별", 
        "start": "2026-06-29", "color": "#E59866"  # 파스텔 오렌지
    },
    {
        "title": "🥤 [MD] 7월 엔드OSC 취합\n👤 담당: 이종혁\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-06-29", "color": "#A9DFBF"  # 파스텔 민트 그린
    }
]
