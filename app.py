...
calendar_events = [
    ...
    # --- 7월 3주차 신규 데이터 (총 7건) ---
    {
        ...
        "start": "2026-07-17", "color": "#76D7C4" #
    },
    {
        "title": "🎒 [지원] 펩시 보냉백 발주 2차\n👤 담당: 임명섭\n📝 방법: OFC포탈\n🎯 주체: OFC개별", #
        "start": "2026-07-20", "color": "#A3E4D7" #
    },
    {
        "title": "📊 [지원] 재고조사 지연점(19점)\n👤 담당: 유찬울\n📝 방법: OFC포탈\n🎯 주체: OFC개별", #
        "start": "2026-07-20", "color": "#FAD7A0" #
    },
    {
        "title": "🍦 [MD] 8월 아크 매출활성화\n👤 담당: 이주용\n📝 방법: OFC포탈\n🎯 주체: OFC개별", #
        "start": "2026-07-20", "color": "#F5B041" #
    },
    {
        "title": "🎨 [마케팅] 노후그래픽 교체\n👤 담당: 정상희\n📝 방법: 엑셀/PPT\n🎯 주체: 부문지원팀", #
        "start": "2026-07-24", "color": "#C39BD3" #
    },
    {
        "title": "🛑 [O4O] 점포 임시중단 희망\n👤 담당: 상현수\n📝 방법: OFC포탈\n🎯 주체: OFC개별", #
        "start": "2026-07-27", "color": "#F1948A" #
    },
    {
        "title": "🍗 [MD] 6월 치킨25 소급 취합\n👤 담당: 최원필\n📝 방법: OFC포탈\n🎯 주체: OFC개별", #
        "start": "2026-07-31", "color": "#F7DC6F" #
    }
]
