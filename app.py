...
calendar_events = [
    {"title": "📢 [마케팅] 토스 설치 (최수민 / 엑셀 / 부문지원팀)", "start": "2026-04-20", "end": "2026-05-01", "color": "#D98880"},  # 차분한 코랄 레드
    {"title": "🧼 [지원] 선도위생 제외 (이충언 / 엑셀 / 지역팀)", "start": "2026-04-20", "end": "2026-04-28", "color": "#7FB3D5"},  # 차분한 스카이 블루
    {"title": "🥤 [MD] OSC 장려금 (이종혁 / 엑셀 / 부문지원팀)", "start": "2026-04-20", "end": "2026-04-29", "color": "#7DCEA0"},  # 차분한 민트 그린
    {"title": "🛒 [지원] 장보기 추가 (양희진 / 시스템 / OFC개별)", "start": "2026-04-20", "end": "2026-04-28", "color": "#C39BD3"},  # 차분한 라벤더 보라
    {"title": "🛵 [O4O] 배달/픽업 (박정은 / OFC포탈 / OFC개별)", "start": "2026-04-20", "end": "2026-04-28", "color": "#F0B27A"},  # 차분한 샌드 오렌지
    {"title": "🍗 [MD] 치킨25 소모품 (최원필 / OFC포탈 / OFC개별)", "start": "2026-04-13", "end": "2026-05-01", "color": "#73C6B6"},  # 차분한 청록색
]
calendar_options = {
    "headerToolbar": {
