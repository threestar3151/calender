...
calendar_events = [
    # --- 과거 누적 데이터 (4월 ~ 8월 3주차 전체 생략 없이 포함) ---
    ...
    {
        "title": "🛒 [지원] 9월 장보기 추가\n👤 담당: 양희진\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-08-30", "color": "#F7DC6F"  # 파스텔 옐로우
    },
    {
        "title": "🍜 [MD] 농심 라면 선물세트\n👤 담당: 김윤지\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-08-31", "color": "#FAD7A0"  # 파스텔 피치
    },
    {
        "title": "🧼 [지원] 9월 선도위생 제외\n👤 담당: 이충언\n📝 방법: 엑셀\n🎯 주체: 지역팀", 
        "start": "2026-08-31", "color": "#A3E4D7"  # 파스텔 민트
    },
    {
        "title": "🗑️ [지원] 점두 유휴집기 철거\n👤 담당: 이민석\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-09-04", "color": "#E59866"  # 파스텔 오렌지
    },
    {
        "title": "🛑 [O4O] 추석 사전예약 미운영\n👤 담당: 김대영/임혁\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-09-07", "color": "#AED6F1"  # 파스텔 스카이블루
    }
]
