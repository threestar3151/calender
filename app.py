...
calendar_events = [
    # --- 과거 누적 데이터 (4월 ~ 7월 2주차 전체 생략 없이 포함) ---
    ...
    {
        "title": "🛒 [지원] 8월 장보기 추가\n👤 담당: 양희진\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-07-27", "color": "#F7DC6F"  # 파스텔 옐로우
    },
    {
        "title": "🛵 [O4O] 배달/픽업 13차\n👤 담당: 홍민규\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-07-27", "color": "#AED6F1"  # 파스텔 스카이블루
    },
    {
        "title": "🎁 [지원] 프로모션 개인정보\n👤 담당: 장한솔\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-07-27", "color": "#D7BDE2"  # 파스텔 퍼플
    },
    {
        "title": "🧼 [지원] 8월 선도위생 제외\n👤 담당: 이충언\n📝 방법: 엑셀\n🎯 주체: 지역팀", 
        "start": "2026-07-27", "color": "#A3E4D7"  # 파스텔 민트
    },
    {
        "title": "👤 [지원] 실운영자 정보 2차\n👤 담당: 김동욱\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-07-27", "color": "#F5CBA7"  # 파스텔 피치
    },
    {
        "title": "❤️ [지원] 자동심장충격기 현황\n👤 담당: 이경준\n📝 방법: 엑셀\n🎯 주체: 부문지원팀", 
        "start": "2026-08-03", "color": "#F1948A"  # 파스텔 핑크레드
    }
]
