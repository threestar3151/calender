...
calendar_events = [
    ...
    # --- 9월 3주차 신규 데이터 (총 5건) ---
    {
        ...
        "start": "2026-09-21", "color": "#A9DFBF"  # 파스텔 그린
    },
    {
        "title": "🍦 [MD] 10월 아크 매출활성화\n👤 담당: 이주용\n📝 방법: OFC포탈\n🎯 주체: OFC개별", 
        "start": "2026-09-21", "color": "#FAD7A0"  # 파스텔 피치
    },
    {
        "title": "🧼 [지원] 10월 선도위생 제외\n👤 담당: 이충언\n📝 방법: 엑셀\n🎯 주체: 지역팀", 
        "start": "2026-09-21", "color": "#A3E4D7"  # 파스텔 민트
    },
    {
        "title": "🛒 [기타] 11월 빼빼로 이동진열대\n👤 담당: 김치영\n📝 방법: 엑셀\n🎯 주체: 지역팀", 
        "start": "2026-09-30", "color": "#F7DC6F"  # 파스텔 옐로우
    },
    {
        "title": "⚽ [MD] 스포츠토토 갱신서류\n👤 담당: 이수빈\n📝 방법: PPT\n🎯 주체: 부문지원팀", 
        "start": "2026-10-05", "color": "#C39BD3"  # 파스텔 라일락
    }
]
